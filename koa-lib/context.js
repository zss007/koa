...
const proto = module.exports = {
  ...
  // 抛出带有状态码和报错信息的 Error 对象：this.throw(403) | this.throw('name required', 400) | this.throw(400, 'name required')
  // | this.throw('something exploded') | this.throw(new Error('invalid'), 400) | this.throw(400, new Error('invalid'));
  throw(...args) {
